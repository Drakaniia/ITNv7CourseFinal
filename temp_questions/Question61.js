// Initialize Question61 (Matching question - treated as multi-select with all options correct)
export function initQ60({ state, CORRECT, updateScoreStrip, updateDots }) {
  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      state.answers[60] = parseInt(btn.dataset.idx);
