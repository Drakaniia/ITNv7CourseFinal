// Initialize Question16
export function initQ15({ state, CORRECT, updateScoreStrip, updateDots }) {
  const optsEl = document.getElementById("opts-15");
  const submitEl = document.getElementById("submit-15");
  const expEl = document.getElementById("exp-15");
  const verdictEl = document.getElementById("verdict-15");
