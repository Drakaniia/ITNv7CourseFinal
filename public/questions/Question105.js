// Initialize Question105
export function initQ104({ state, CORRECT, updateScoreStrip, updateDots }) {
  const optsEl = document.getElementById("opts-104");
  const submitEl = document.getElementById("submit-104");
  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      state.answers[104] = parseInt(btn.dataset.idx);
