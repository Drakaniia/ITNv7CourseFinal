#!/usr/bin/env python3
"""
Fix multi-select question logic to properly handle wrong answers.
The bug: After clicking a wrong answer, it shows as wrong but doesn't reveal the correct answers.
The fix: Disable wrong answer buttons immediately and ensure proper state management.
"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Fixed {fixed_count} multi-select question files")
    print(f"{'='*60}")
